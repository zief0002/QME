#' Calculate generalizability and/or dependability.
#'
#' This function calculates generalizability and/or dependability coefficients from estimated generalizability study variance components.  This function also returns relative and/or absolute error variances and standards or measurement.
#'
#' @param gVar.out a data frame consisting of a column named "Source" containing named sources of variation, a column named "Variance" containing estimated variance components, and a column named "N" containing the number of conditions by which variance components will be divided.
#' @param object a character string specifying which named source of variation is the object of measurement.
#' @param type a character string taking the value of "both" (default), "relative", or "absolute".
